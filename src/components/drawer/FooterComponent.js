...
export const FooterComponent = ({navigation}) => {
  ...
  return (
    <View style={{borderTopWidth: 1, borderTopColor: '#50576d', display: 'flex', flexDirection: 'row', justifyContent: 'space-between', margin: 8, paddingTop: 12}}>
      ...
      <TouchableOpacity style={{alignContent: 'center', alignItems: 'center', borderLeftWidth: 0.5, borderLeftColor: '#50576d', flexDirection: 'row', flexGrow: 0.5, justifyContent: 'center'}} onPress={() => {RootApp.closeDrawer();dispatch(signOut())}}>
